...
import { BsChatLeft, BsChatLeftHeart } from 'react-icons/bs'
...
const NavButton = ({title,customFunc, icon,color,dotColor})=>(
  <TooltipComponent content={title} position='BottomCenter'>
    <button type="button" onClick={customFunc} style={{color}} className='relative text-xl rounded-full p-3 hover:bg-light-gray'>
      ...
      />
        {icon} 
        {/* prvious <span style was wrapping icom as well so they were
        appearing smaller. */}
    </button>
    ...
    color="blue" icon={<AiOutlineMenu/>}/>
      <div className='flex'>
        ...
        color="blue" icon={<BsChatLeft/>}/>
          ...
          <NavButton title="Chat" dotColor="#03C9D7"customFunc={()=>handleClick('notification')}
        ...
        >
          ...
          <p>
              ...
              <span className='text-gray-400 font-bold ml-1 text-14'>Nik</span>
          </p>
